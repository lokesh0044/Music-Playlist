...
import SongCover from '../SongCover/index'
...
class MusicPlaylist extends Component {
  ...
  onClickDeleteButton = id => {
    ...
    const updatedTracksList = tracksList.filter(eachSong => eachSong.id !== id)
  ...
  render() {
    ...
    const filteredTrackList = tracksList.filter(eachSong =>
        ...
        <ResponsiveContainer>
          ...
          <SongsPlayListContainer>
            ...
            {filteredTrackList.length === 0 ? (
              ...
              <PlayList>
                {filteredTrackList.map(eachSong => (
                  <SongCover
